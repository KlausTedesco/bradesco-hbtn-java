 ...
 * 
 * public static void main(String[] args) { ProcessadorVideo processadorVideo1 =
 * new ProcessadorVideo(); processadorVideo1.registrarCanal(new Slack());
 ...
 * 
 * Video video1 = new Video("video1.mpg", FormatoVideo.MPEG); Video video2 = new
 * Video("video2.avi", FormatoVideo.AVI); Video video3 = new Video("video3.mkv",
 * FormatoVideo.MKV);
 * 
